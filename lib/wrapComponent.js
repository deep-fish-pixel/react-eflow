    ...
    _createClass(WrapComponent, [{
      ...
      value: function bindUpdater() {
        ...
        if (updaters && updaters.length) {
          ...
          var _loop = function _loop(_i) {
            ...
            propsKey = isMethod ? (0, _method.getOriginalMethodName)(updater) : updater.propsKey || (0, _method.getOriginalMethodName)(updater);
      ...
      * */
      ...
      value: function render() {
        ...
        return _react2.default.createElement(_Component, _extends({}, state, this.props));
      }
    }]);
