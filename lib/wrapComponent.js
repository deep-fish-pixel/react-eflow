...
var wrapComponent = function wrapComponent(_Component, updaters, customPropsMapping) {
  var WrapComponent = function (_Component2) {
    ...
    function WrapComponent(props) {
      ...
      var _this = _possibleConstructorReturn(this, (WrapComponent.__proto__ || Object.getPrototypeOf(WrapComponent)).call(this, props));
    ...
    _createClass(WrapComponent, [{
      ...
      value: function shouldComponentUpdate(nextProps, nextState) {
        return !(0, _shallowequal2['default'])(this.props, nextProps) || !(0, _shallowequal2['default'])(this.state, nextState); //todo: 可优化处理
      }
      ...
      value: function bindUpdater() {
        ...
        if (updaters && updaters.length) {
          ...
          var _loop = function _loop(_i) {
            updater = updaters[_i];
            process.env.NODE_ENV !== 'production' && (0, _invariant2['default'])(updater, 'wrapComponent(%s) 方法中, 绑定store的方法为空', (0, _method.getMethodName)(_Component));
            ...
            propsKey = isMethod ? (0, _method.getOriginalMethodName)(updater) : originUpdater.propsKey || (0, _method.getOriginalMethodName)(updater);
            _eflowKey = updater._eflowKey;
            store = updater.ref;
            var update = getState.bind(_this2, store, propsKey, updater, customPropsMapping);
            event[_eflowKey] = function callUpdate() {
              update(true);
            };
            _pubSub2['default'].sub(_eflowKey, event[_eflowKey]);

            //初始化该方法对应的state值
            Object.assign(state, getState.call(_this2, store, propsKey, updater));
            i = _i;
          };
