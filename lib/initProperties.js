...
function initProperties(obj, id) {
	...
	var delay = new _Delay2['default']();

	(0, _prototype.forEachPrototype)(obj, function (method, methodName) {
		if (methodName !== 'constructor') {
			var innerMethod = function innerMethod() {
			...
			method = getWrapInnerMethod(obj, method, methodName, innerMethod, originalDispatch, originalContextDispatch, originalData, originalContextData);
...
* 包装innerMethod
* */
function getWrapInnerMethod(target, method, methodName, innerMethod, originalDispatch, originalContextDispatch, originalData, originalContextData) {
