    ...
    if (methodName !== 'constructor') {
      ...
      * */
      ...
      var extend = {
        ...
        flows: {},
        //指定该方法跟随flower方法同步更新
        flowFrom: function flowFrom(flower) {
          var _eflowKey = flower._eflowKey;
          process.env.NODE_ENV !== 'production' && (0, _invariant2.default)(_eflowKey, '%s.%s 方法, _eflowKey值为空', (0, _method.getMethodName)(flower.ref.constructor), (0, _method.getMethodName)(flower) || 'method');
          process.env.NODE_ENV !== 'production' && (0, _invariant2.default)(!this.flows[_eflowKey], '%s.%s 已同步 %s.%s', (0, _method.getMethodName)(this.ref.constructor), (0, _method.getMethodName)(this) || 'method', (0, _method.getMethodName)(flower.ref.constructor), (0, _method.getMethodName)(flower) || 'method');
