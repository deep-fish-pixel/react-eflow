...
function assign(target, propName, mergeValue, className, methodName) {
  ...
  if ((0, _types.isArray)(curValue)) {
    if (arguments.length >= 3 && (0, _types.isArray)(mergeValue)) {
  ...
  _createClass(Store, [{
    ...
    * */
    ...
    value: function dispatch(method, value) {
      ...
      this.updateQueue.exec(function (name, nextValue, method) {
        _this.pub(method);
      });
    }
    ...
    * */
    ...
    key: 'change',
    value: function change(state, name, value, method) {
      var curValue = state[name],
          nextValue = void 0,
          shouldUpdate = void 0;
      ...
      if (shouldUpdate || !(0, _shallowequal2['default'])(curValue, nextValue)) {
