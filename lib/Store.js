  ...
  * */
  ...
  _createClass(Store, [{
    ...
    value: function initState(data) {
      ...
      this._cloneState = (0, _clone2['default'])(state);
    }
    ...
    value: function reset() {
      this.state = (0, _clone2['default'])(this._cloneState || {});
    }
    ...
    * */
    ...
    value: function _data(invokerArguments, invokeName) {
      ...
      if (!method) {
        process.env.NODE_ENV !== 'production' && (0, _invariant2['default'])(method, invokeName + '\u65B9\u6CD5\u7684\u7B2C\u4E00\u4E2A\u53C2\u6570\u503C\u4E0D\u80FD\u4E3A\u7A7A, \u8BE5\u503C\u5E94\u8BE5\u662F\u65B9\u6CD5\u7C7B\u578B');
      }
