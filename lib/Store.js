    ...
    * */
    ...
    value: function _dispatch(method, value, invokeName) {
      ...
      if (method) {
        ...
        process.env.NODE_ENV !== 'production' && (0, _invariant2['default'])(stateKey, '调用%s.%s 方法, 参数值%s 的stateKey为空, stateKey属性在构造函数中进行初始化, 应该是非原型方法', (0, _method.getMethodName)(this.constructor), invokeName, (0, _method.getMethodName)(method) || 'method');
    ...
    * */
    ...
    value: function _data(invokerArguments, invokeName) {
      var method = invokerArguments[0],
          ...
          stateKey = method.stateKey;
      process.env.NODE_ENV !== 'production' && (0, _invariant2['default'])(stateKey, '调用%s.%s 方法, 参数值%s 的stateKey为空, stateKey属性在构造函数中进行初始化, 应该是非原型方法', (0, _method.getMethodName)(this), invokeName, (0, _method.getMethodName)(method) || 'method');
