  ...
  _createClass(Store, [{
    ...
    * */
    ...
    value: function dispatch(method, value) {
      ...
      if (method) {
        ...
        process.env.NODE_ENV !== 'production' && (0, _invariant2['default'])(stateKey, '调用%s.dispatch 方法, 参数值%s 的stateKey为空, stateKey属性在构造函数中进行初始化, 应该是非原型方法', (0, _method.getMethodName)(this), (0, _method.getMethodName)(method) || 'method');
    ...
    * */
    ...
    value: function data(method, value) {
      ...
      process.env.NODE_ENV !== 'production' && (0, _invariant2['default'])(stateKey, '调用%s.data 方法, 参数值%s 的stateKey为空, stateKey属性在构造函数中进行初始化, 应该是非原型方法', (0, _method.getMethodName)(this), (0, _method.getMethodName)(method) || 'method');
